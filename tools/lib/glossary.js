...
\************************************/
  ...
  "カイエンヌ":"Cumin Contagion",
  "ダブルブー":"Double Gloomy",
  "グルヌイユ":"Marinara Miasma",
  "コールパウダー":"Call Pretty",
  "レッドローズ":"Red Rose",
  "イエローローズ":"Yellow Rose",
  "クリアスラッシュ":"Clear Edgy",
...
\************************************/
  ...
  "クムヤムトの穴":"Muy Mot Desert",
  "ガラムマサラ":"Garam Masala",
  "死の回廊":"Abyssal Corridor",
  "魔バス":"Magic Bus",
  "海岸の洞窟":"Beach Cave",
  "タンドーリ":"Tandoori",
  "ワクティ村":"Green Tea Village",
  "マサラティ村":"Masala Chai Village",
  "タピオカティ村":"Tapioca Tea Village",
  "ロッシュの川べり":"Riviere de la Roche",
  "メースの家":"Mace's House",
  "モイロロト村":"May Village",
  "ガスパチョ村":"Gazpacho Village",
  "モギナスの魔窟":"Drazzig Grotto",
  "モギナス魔窟":"Drazzig Grotto",
  "ラキューオ":"Arko",
  "文鳥の里":"Ricebird Village",
  "ピップルスタウン":"Ville de Souris",
  "ゲアラヴァ村":"Ufot Village",
  "失意の沼":"Despair Swamp",
  "暗闇の地":"Land of Darkness",
  "モギナスの口":"Outer Drazzig",
  "ヴァレンシア海岸":"Valencia Beach",
  "バレンシア海岸":"Valencia Beach",
  "ミモレットの森":"Mimolette Forest",
  "キード・モンガ":"Iko Domnag",
  "文鳥ケ原":"Ricebird Plains",
  "イベンセ岩場":"Rekcarc Quarry",
  "レヒカフ沼":"Spollacs Swamp",
  "氷の島":"Ice Island",
  "東の森":"Eastern Forest",
  "王者の森":"Eastern Forest",
  "エニグマの森":"Enigma Forest",
  "ツリーマンの集落":"Treeman Colony",
  "クガンデ村":"Osim Village",
  "ウィルオウィスプ":"Will-o'-Wisp Academy",
  "クムヤムト砂漠":"Muy Mot Desert",
  "ブラウニーの穴":"Brownie Cavern",
  "バソリモ村":"Abos Village",
  "アクアビット城":"Akvavit Castle",
  "文鳥温泉":"Ricebird Springs",
  "荒廃の地":"The Badlands",
  "大岩":"The Great Rock",
  "シサバレイ":"Tuoekat",
  "リドナヒー":"Yekrut",
  "回復の泉":"Spring of Healing",
  "大浴場":"Large Bathtub",
  "大岩温泉":"Large Spring",
  "石灰棚の泉":"Limestone Spring",
  "五右衛門風呂":"Goemon's Bath",
  "滝の湯":"Waterfall Bath",
  "ジャグジー":"Jacuzzi",
  "ローマ大理石風呂":"Roman Bath",
  "ジャングル風呂":"Jungle Bath",
  "ひのき風呂":"Cypress Bath",
  "宝石の泉":"Jeweled Spring",
  "パラダイス風呂":"Paradise Bath",
  "アジアンリゾート":"Valencia Resort",
  "御殿風呂":"Emperor's Bath",
  "赤池地獄":"Lava Bath",
  "ドラム缶風呂":"Drum Can",
  "ずんどこ穴":"Opopmat Cave",
  "再生の間":"Hall of Rebirth",
/************************************\
*            [[Enemies]]             *
\************************************/
  "スノウヘア":"Snowhair",
